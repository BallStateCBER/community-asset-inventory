...
Tooltip.prototype = {
	initialize: function(el, options) {
		...
		Element.childElements(this.el).each(function(el){
		...
		if(this.initialized) {
			...
			new Effect.Fade(this.tooltip, {
				...
				afterFinish: function() {
					// Conditional added by Graham to avoid error message
	...
	setup: function(){
		...
		this.tooltip.style.left = this.xCord + 5 + "px";
		this.tooltip.style.top = this.yCord + 15 + "px";
	},
